...
def hello(request, name="Nanashi"):
    visits = int(request.COOKIES.get('visits', 0)) + 1
    response = render(request, 'sbxapp/hello.html',
...
def dt_all(request):
    ...
    data = serializers.serialize('json', dt_demos)
...
def dt_all2(request):
    ...
    return JsonResponse(data, safe=False)  # safe=False: listなどdict以外を返すとき
